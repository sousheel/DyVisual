...
//    srand(time(NULL));
    ...
    triangleScene = (TriangleScene*) sceneManager.add(new TriangleScene());
    randomPointScene = (RandomPointScene*) sceneManager.add(new RandomPointScene());
...
void ofApp::mouseReleased(int x, int y, int button){
    ...
    p = ofPoint(x,y);
    randomPointScene->randPoints.push_back(p);
}
...
void ofApp::beatEvent(float & time) {
    ...
    //Update for every scene
    triangleScene->gotBeat = true;
    randomPointScene->gotBeat = true;
}
